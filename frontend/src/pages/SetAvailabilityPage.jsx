...
const SetAvailabilityPage = () => {
  ...
  const POTENTIAL_SLOTS = [
      { id: 's1', startTime: '07:00', endTime: '09:00', period: 'Sáng' },
      { id: 's2', startTime: '09:00', endTime: '11:00', period: 'Sáng' },
      { id: 's3', startTime: '13:00', endTime: '15:00', period: 'Chiều' },
      { id: 's4', startTime: '15:00', endTime: '17:00', period: 'Chiều' },
      { id: 's5', startTime: '17:00', endTime: '19:00', period: 'Tối' },
  ];
  ...
  const toggleSlot = (templateSlot) => {
      ...
      if (existingIndex >= 0) {
          ...
          if (currentDaySlots[existingIndex].isBooked) {
              setMessage({ type: 'error', text: 'Không thể xóa khung giờ đã được đặt' });
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Cài Đặt Lịch Trống</h1>
        <button 
            onClick={handleSave}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="p-6">
            <h3 className="text-lg font-semibold mb-4 flex items-center">
                ...
                Khung Giờ Cho {selectedDate.toLocaleDateString('vi-VN', { weekday: 'long', month: 'long', day: 'numeric' })}
            </h3>
                ...
                {POTENTIAL_SLOTS.map((slot) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            {isBooked ? (
                                <span className="text-xs font-medium text-orange-600 bg-orange-100 px-2 py-1 rounded">Đã Đặt</span>
                            ) : (
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg text-sm text-gray-600">
                ...
                <ul className="list-disc pl-5 space-y-1">
                    <li>Các khung giờ viền xanh có sẵn cho sinh viên đặt.</li>
                    <li>Các khung giờ đã được đặt không thể xóa ở đây. Vui lòng hủy buổi học từ Bảng Điều Khiển nếu cần.</li>
                </ul>
            </div>
        </div>
      </div>
